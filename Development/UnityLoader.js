...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'DisasterGirlsProject.data';
    var REMOTE_PACKAGE_BASE = 'DisasterGirlsProject.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 27781558;
      var PACKAGE_UUID = '0a4edfb4-fe4e-42da-886e-1f31945eb077';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 24731220, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(24731220, 24731389, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(24731389, 24735045, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(24735045, 26878961, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(26878961, 27753933, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(27753933, 27781558, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_DisasterGirlsProject.data');

    };
    Module['addRunDependency']('datafile_DisasterGirlsProject.data');
